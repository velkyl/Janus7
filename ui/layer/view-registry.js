...
async function buildSessionPrepView(engine) {
  ...
  if (typeof SessionPrepService !== 'function') {
    return {
      ...
      academySeed: null,
      academyFollowUp: { queuedEvents: [], factionPressure: [], socialPressure: [], questPressure: [], summary: { queuedEvents: 0, factionPressure: 0, socialPressure: 0, questPressure: 0, totalHotItems: 0 } },
      consequenceSeed: null,
  ...
  return {
    ...
    academyFollowUp: report.academyFollowUp ?? { queuedEvents: [], factionPressure: [], socialPressure: [], questPressure: [], summary: { queuedEvents: 0, factionPressure: 0, socialPressure: 0, questPressure: 0, totalHotItems: 0 } },
    consequenceSeed: report.consequenceSeed ?? null,
